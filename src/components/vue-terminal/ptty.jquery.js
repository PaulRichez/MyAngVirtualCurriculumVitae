        ...
        * */
        var get_defaults = function () {
            ...
            return {
                ...
                startCommand: null, // start with the command
                passCommand: null,
        ...
        this.each(function () {
            ...
            **/
            _public.native_commands = function () {
                settings.registerCommand.forEach((c) => {
            ...
            **/
            ...
            el.append(
                ...
                '</div>' +
                '<div class="prompt">' +
                '<div id="terminal-input" class="input" contenteditable ' +
                'spellcheck="false" ' +
            ...
            **/
            ...
            // Paul run command on start
            if (settings.startCommand) {
                _public.run_command(settings.startCommand)
            }
            /**
            * @method   : Anonymous
